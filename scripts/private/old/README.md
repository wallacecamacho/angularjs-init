...
folder `angular-app-init-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `angular-app-init-snapshots` folder, containing
